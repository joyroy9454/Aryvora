...
3. [Step-by-Step: Build Your Site with GitHub Pages + Hugo](#step-by-step-github-pages)
4. [What to Include on Your Personal Website](#what-to-include)
5. [Custom Domain Tips (Get a Free .me or .dev Domain)](#custom-domain-tips)
6. [SEO Basics for Your Personal Site](#seo-basics)
...
**Difficulty:** Moderate (some command-line work)
**Best for:** CS students, developers, anyone who wants to learn Git
...
**Cost:** Free plan available (with WordPress.com subdomain)
**Difficulty:** Easy
**Best for:** Students who want to blog regularly
...
**Cost:** Free plan available (with Wix subdomain and ads)
**Difficulty:** Very easy
**Best for:** Students who want a drag-and-drop visual editor
...
**Difficulty:** Very easy
**Best for:** Students who just need a simple landing page
...
**Cost:** Completely free with Google account
**Difficulty:** Very easy
**Best for:** Students who want the simplest possible option
...
## Step-by-Step: Build Your Site with GitHub Pages + Hugo {#step-by-step-github-pages}
...
Hugo uses themes to control the look and your site. There are hundreds of free themes at [themes.gohugo.io](https://themes.gohugo.io). For this tutorial, I'll use the "PaperMod" theme, which is clean, fast, and perfect for personal websites.
...
## What to Include on Your Personal Website {#what-to-include}
...
## Custom Domain Tips (Get a Free .me or .dev Domain) {#custom-domain-tips}
...
If you're a student, sign up for the [GitHub Student Developer Pack](https://education.github.com/pack). It includes:
...
Freenom used to offer free `.tk`, `.ml`, `.ga`, `.cf`, and `.gq` domains. Availability has become limited, but it's worth checking if you want a truly free option.
...
## SEO Basics for Your Personal Site {#seo-basics}
...
- Compress images before uploading (use [tinypng.com](https://tinypng.com) for free)
...
- [vibe coding for beginners](/posts/what-is-vibe-coding/)
