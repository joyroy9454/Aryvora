...
faq:
  ...
  - question: "Can AI tools really help you study smarter?"
    answer: "Yes. AI tools use evidence-backed techniques like spaced repetition, active recall, and adaptive explanations to help you retain more in less time. Students using these tools typically see significant improvements in exam performance."
  - question: "Is using AI to study considered cheating?"
    answer: "Using AI as a study aid — like flashcards, tutoring, or research help — is not cheating. It's the same as using a calculator in math. However, using AI to complete assignments or exams without permission violates academic integrity policies at most schools."
  - question: "How do I study smarter, not harder, in college?"
    answer: "Focus on active recall (testing yourself), spaced repetition (reviewing at increasing intervals), and understanding over memorization. AI tools like Anki, NotebookLM, and Perplexity make these techniques easier to implement consistently."
  - question: "What are the best AI tools for college students in 2026?"
...
3. [7 AI Tools That Actually Help](#7-ai-tools-that-actually-help)
   - [NotebookLM by Google](#1-notebooklm-by-google--turn-notes-into-a-study-partner)
   - [Anki + AI Add-ons](#2-anki--ai-add-ons--spaced-repetition-on-steroids)
   - [Quizlet AI](#3-quizlet-ai--flashcards-games-and-ai-tutoring)
   - [Perplexity AI](#4-perplexity-ai--research-that-actually-cites-sources)
   - [Wolfram Alpha](#5-wolfram-alpha--math-and-science-problem-solver)
   - [Otter.ai](#6-otterai--never-miss-a-lecture-again)
   - [Claude](#7-claude--your-patient-study-buddy)
4. [Subject-Specific AI Tool Recommendations](#subject-specific-ai-tool-recommendations)
5. [Build Your AI Study System: A Step-by-Step Framework](#build-your-ai-study-system-a-step-by-step-framework)
6. [The Dark Side: When AI Hurts Your Learning](#the-dark-side-when-ai-hurts-your-learning)
7. [Study Smarter Daily Routine](#study-smarter-daily-routine)
...
1. Upload all your lecture notes for one subject
2. Ask: "Quiz me on the key concepts from these notes"
3. Ask: "Explain [topic] as if I'm seeing it for the first time"
4. Generate an Audio Overview and listen during your commute
...
3. Use ChatGPT or Claude to generate flashcard content from your notes
4. Import into Anki and start reviewing
...
**Link:** [apps.ankiweb.net](https://apps.ankiweb.net)
...
2. Use Wolfram Alpha to check your answer
3. Study the step-by-step solution to understand where you went wrong

**Price:** Basic computation free. Step-by-step solutions require Pro ($5.49/month — worth it for STEM students).

**Link:** [wolframalpha.com](https://wolframalpha.com)
...
1. **During class:** Press record and focus entirely on listening and engaging. Don't try to write everything down — Otter captures it all. Instead, jot quick questions or mark moments where you got confused.
2. **Right after class (5 min):** Skim the transcript while the lecture is fresh. Edit any mistranscriptions of technical terms. Highlight key concepts.
3. **Within 24 hours (15 min):** Ask Otter's AI to generate a summary and extract key terms. Copy these into your NotebookLM project for that course.
4. **Before exams:** Use the search function to find every mention of a specific topic across all lectures. This is incredibly powerful for studying themes that span multiple classes.
...
1. Pick a concept you need to learn
2. Ask Claude to explain it
3. Try to explain it back to Claude in your own words
4. Claude will tell you where your explanation is weak
...
1. **NotebookLM** — upload your current semester's materials
2. **Anki** — set up decks for each subject
3. **Otter.ai** — install on your phone for lecture recording
...
1. Upload notes to NotebookLM
2. Generate 5-10 Anki cards from key concepts
3. Ask NotebookLM: "What are the three most important ideas from this material?"
...
1. Review all Anki cards due that week
2. Generate Audio Overview in NotebookLM for one subject
